const stats = [
  { value: "50+", label: "PROJECTS SHIPPED", border: true },
  { value: "30+", label: "GLOBAL CLIENTS", border: true },
  { value: "99%", label: "UPTIME SLA", border: true },
  { value: "4.9★", label: "CLIENT RATING", border: false },
];
