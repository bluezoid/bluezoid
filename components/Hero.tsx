    ...
    <section className="relative flex flex-col items-center w-full bg-[#0A0A0A] py-16 px-6 md:py-[100px] md:px-[120px] overflow-hidden">
      ...
      <div className="flex items-center justify-center gap-[8px] h-[32px] px-[12px] md:px-[16px] bg-[#1A1A1A] border-2 border-[#FFD600]">
        ...
        <span className="font-ibm-mono text-[9px] md:text-[11px] font-bold text-[#FFD600] tracking-[1px] md:tracking-[2px] whitespace-nowrap">
          [NEW] // DEVELOPER-FIRST SOFTWARE AGENCY · INDIA
        </span>
      </div>
      ...
      <h1 className="font-grotesk text-[clamp(32px,10vw,96px)] font-bold text-[#F5F5F0] tracking-[-1px] leading-none text-center w-full max-w-[1100px]">
        <GlitchText text="WE ENGINEER" speed={45} delay={100} />
        <br />
        <GlitchText text="SOFTWARE THAT" speed={45} delay={400} />
      </h1>
      <h1 className="font-grotesk text-[clamp(32px,10vw,96px)] font-bold text-[#FFD600] tracking-[-1px] leading-none text-center w-full max-w-[1100px]">
        <GlitchText text="SCALES." speed={45} delay={700} />
      </h1>
      ...
      <p className="font-ibm-mono text-[13px] md:text-[15px] text-[#888888] tracking-[1px] leading-[1.6] text-center w-full max-w-[800px]">
        PRODUCTION-GRADE SAAS PLATFORMS, WEB APPLICATIONS AND API SYSTEMS —
        ARCHITECTURED FOR RESILIENCE, DESIGNED FOR VELOCITY.
        <br />
      ...
      <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-[16px] w-full sm:w-auto">
        <Link href="/contact" className="flex items-center justify-center w-full sm:w-[220px] h-[56px] bg-[#FFD600] hover:bg-[#e6c200] transition-colors">
      ...
      <p className="font-ibm-mono text-[11px] text-[#555555] tracking-[2px] text-center">
        NO LOCK-IN CONTRACTS // 48H KICKOFF GUARANTEED // FULL SOURCE OWNERSHIP
      </p>
...
const layers = [
  { label: "SERVICE / SAAS", color: "#FFD600", indent: 0, active: true },
  { label: "APP ROUTER", color: "#888", indent: 12 },
  { label: "AUTH + RBAC", color: "#4ADE80", indent: 12 },
  { label: "BILLING", color: "#888", indent: 12 },
  { label: "API LAYER", color: "#FF6B35", indent: 12 },
  { label: "REST ENDPOINTS", color: "#FF6B35", indent: 24 },
  { label: "WEBHOOKS", color: "#888", indent: 24 },
  { label: "DATABASE", color: "#60A5FA", indent: 12 },
  { label: "DEPLOY / CI", color: "#888", indent: 0 },
];

const inspectProps = [
  { key: "BUILD", val: "PASSING", swatch: "#4ADE80" },
  { key: "ENV", val: "PRODUCTION" },
  { key: "REGION", val: "GLOBAL EDGE" },
  { key: "UPTIME", val: "99% SLA" },
  { key: "STACK", val: "#0F0F0F", swatch: "#0F0F0F" },
  { key: "TESTS", val: "#4ADE80", swatch: "#4ADE80" },
  { key: "LATENCY", val: "< 100MS" },
  { key: "STATUS", val: "SHIPPED" },
];

const tokens = [
  { name: "next.js", hex: "#FFD600" },
  { name: "typescript", hex: "#60A5FA" },
  { name: "postgres", hex: "#4ADE80" },
  { name: "node.js", hex: "#F5F5F0" },
  { name: "ai / llm", hex: "#FF6B35" },
];
...
const tickerItems = [
  "API", "AUTH", "BILLING", "CACHE", "QUEUE",
  "CDN", "WEBHOOK", "DATABASE", "AI MODEL", "CI/CD",
];
  ...
  return (  
    <>
      ...
      >
        ...
        <text x="12" y="23" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">STACK</text>
        ...
        <text x="912" y="23" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">DEPLOY</text>
        ...
        <text x="912" y="300" fontFamily="monospace" fontSize="9" fill="#FFD600" letterSpacing={2} fontWeight="700">TECH STACK</text>
        ...
        <text x="280" y="84" fontFamily="monospace" fontSize="8" fill="#FFD600" letterSpacing={1}>PROJECT / SAAS-PLATFORM — LIVE</text>
        ...
        <text x="325" y="252" fontFamily="monospace" fontSize="7" fill="#0A0A0A" fontWeight="700" letterSpacing={0.5}>START PROJECT</text>
        ...
        <text x="360" y="293" fontFamily="monospace" fontSize="7" fill="#333" letterSpacing={1}>api/routes.ts — BlueZoid</text>
        ...
        <text x="232" y="568" fontFamily="monospace" fontSize="8" fill="#555" letterSpacing={1}>DEPLOYED</text>
        <text x="330" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>9 SERVICES</text>
        <text x="430" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>CI/CD ACTIVE</text>
        <text x="600" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>99% UPTIME</text>
        <text x="730" y="568" fontFamily="monospace" fontSize="8" fill="#333" letterSpacing={1}>bluezoid.in</text>
