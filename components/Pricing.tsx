  ...
  return (
    ...
    >
      ...
      <div className="flex items-end gap-[4px]">
        ...
        <span className="font-ibm-mono text-[13px] text-[#555555] tracking-[1px] mb-[6px]">{period}</span>
      </div>
...
const SPRINT_FEATURES = [
  { label: "FIXED SCOPE, FIXED PRICE", included: true },
  { label: "1 SENIOR ENGINEER", included: true },
  { label: "48H KICKOFF", included: true },
  { label: "WEEKLY DEMOS", included: true },
  { label: "FULL SOURCE OWNERSHIP", included: true },
  { label: "DEDICATED TEAM", included: false },
  { label: "ONGOING SUPPORT", included: false },
  { label: "ARCHITECTURE CONSULTING", included: false },
];

const GROWTH_FEATURES = [
  { label: "MONTHLY RETAINER", included: true },
  { label: "DEDICATED 2-3 ENGINEER TEAM", included: true },
...
const ENTERPRISE_FEATURES = [
  { label: "CUSTOM ENGAGEMENT", included: true },
  { label: "DEDICATED POD, SCALES WITH YOU", included: true },
  { label: "DEDICATED SUPPORT LEAD", included: true },
  { label: "WEEKLY DEMOS", included: true },
  { label: "FULL SOURCE OWNERSHIP", included: true },
  { label: "DEDICATED TEAM", included: true },
  { label: "ONGOING SUPPORT", included: true },
  { label: "ARCHITECTURE CONSULTING", included: true },
];
