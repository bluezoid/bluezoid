...
export default function Features() {
  return (
    ...
    >
      <SectionHeader
        label="[01] // WHY BLUEZOID"
        title={"EVERYTHING YOU NEED\nTO SHIP GREAT SOFTWARE."}
        subtitle="WE BRING TOGETHER THE BEST MODERN ENGINEERING PRACTICES — SO YOU CAN FOCUS ON YOUR PRODUCT."
      />
      ...
      <div className="flex flex-col md:flex-row w-full gap-[2px]">
        ...
        <FeatureCard
          iconColor="#FF6B35"
          title={"SECURITY\nFIRST"}
          description="ZERO EXPOSED SECRETS. SERVER-ONLY API ROUTES, VALIDATION AT EVERY BOUNDARY, OWASP-COMPLIANT BY DEFAULT."
          tag="SECURE"
          tagColor="#FF6B35"
          bgColor="#0F0F0F"
          borderColor="#FF6B35"
