...
const rows = [
  { feature: "DEDICATED SENIOR TEAM", pc: "[✓]", figma: "[—]", sketch: "[✗]", framer: "[—]" },
  { feature: "FIXED SCOPE & PRICE", pc: "[✓]", figma: "[✗]", sketch: "[—]", framer: "[✓]" },
  { feature: "FULL SOURCE CODE OWNERSHIP", pc: "[✓]", figma: "[✓]", sketch: "[✗]", framer: "[✗]" },
  { feature: "48H PROJECT KICKOFF", pc: "[✓]", figma: "[BETA]", sketch: "[✗]", framer: "[✗]" },
  { feature: "POST-LAUNCH SUPPORT", pc: "[✓]", figma: "[✓]", sketch: "[—]", framer: "[✓]" },
  { feature: "NO LOCK-IN CONTRACTS", pc: "[✓]", figma: "[✓]", sketch: "[✗]", framer: "[✗]" },
];
  ...
  return (
    <section id="comparison" className="flex flex-col w-full bg-[#050505] py-16 px-6 md:py-[100px] md:px-[120px] gap-12 md:gap-[64px]">
      <SectionHeader
        ...
        title={"WHY BLUEZOID\nWINS."}
        subtitle="SEE HOW WE STACK UP AGAINST FREELANCERS, OFFSHORE SHOPS, AND BIG AGENCIES."
      />
      ...
      <div className="hidden md:flex flex-col w-full border border-[#2D2D2D]">
        ...
        <div className="flex w-full h-[56px] bg-[#111111] border-b-2 border-b-[#FFD600]">
          ...
          <div className="flex items-center flex-1 px-[32px] bg-[#1A1A1A] border-r border-r-[#2D2D2D]">
            <span className="font-grotesk text-[11px] font-bold text-[#FFD600] tracking-[2px]">BLUEZOID</span>
          </div>
          {["FREELANCERS", "OFFSHORE", "BIG AGENCY"].map((tool, i) => (
      ...
      <div className="flex flex-col md:hidden w-full gap-[2px]">
        ...
        <div className="grid grid-cols-5 bg-[#111111] border border-[#FFD600] border-b-2">
          ...
          <div className="px-2 py-3 bg-[#1A1A1A]">
            <span className="font-grotesk text-[9px] font-bold text-[#FFD600] tracking-[1px]">BZ</span>
          </div>
          <div className="px-2 py-3">
            <span className="font-grotesk text-[9px] font-bold text-[#555555] tracking-[1px]">FRL</span>
          </div>
          <div className="px-2 py-3">
            <span className="font-grotesk text-[9px] font-bold text-[#555555] tracking-[1px]">OFF</span>
          </div>
        </div>
        {rows.map((row, i) => (
